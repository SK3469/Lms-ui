...
const SearchPage = () => {
  const [searchParams] = useSearchParams();// getting from courseAPI < useGetSearchCourseQuery
  ...
  return (
    <div className='max-w-7xl mx-auto my-16 p-4 md:p-8'>
      <div>
        <h1>Search result for "{query}"</h1>
        <p>Showing results for "{query}"
